...
export class CancelCommand extends BaseCommand {
    ...
    protected async executeCommand(ctx: BotContext): Promise<void> {
        ...
        try {
            ...
            await ctx.reply("❌ An error occurred while canceling the operation. Please try again.");
        }
    }
}
...
export class ResetCommand extends BaseCommand {
    ...
    protected async executeCommand(ctx: BotContext): Promise<void> {
        ...
        try {
            ...
            const resetMessage = "🔄 **Conversation Reset Complete**\n\n" +
            ...
            await ctx.reply("❌ An error occurred while resetting your conversation state. Please try again.");
        }
    }
}
