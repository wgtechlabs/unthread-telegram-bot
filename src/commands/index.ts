...
import { CancelCommand, ResetCommand } from './basic/StateCommands.js'
...
export function initializeCommands(): void {
  ...
  commandRegistry.registerConversationProcessor(
    new SupportConversationProcessor()
  )
...
export const processSupportConversation = async (
  ctx: BotContext
): Promise<boolean> => {
  try {
...
export const processSetupTextInput = async (
  ctx: BotContext
): Promise<boolean> => {
  try {
    return await processConversation(ctx)
...
export const processTemplateEditInput = async (
  ctx: BotContext
): Promise<boolean> => {
  try {
    return await processConversation(ctx)
...
export const handleTemplateEditCallback = async (
  ctx: BotContext,
...
export const handleTemplateCancelCallback = async (
  ctx: BotContext
): Promise<void> => {
  try {
    await processCallback(ctx)
...
export const handleTemplateCancelEditCallback = async (
  ctx: BotContext
): Promise<void> => {
  try {
    await processCallback(ctx)
...
export const handleTemplateBackMenuCallback = async (
  ctx: BotContext
): Promise<void> => {
  try {
    await processCallback(ctx)
...
LogEngine.info('🎉 Clean Command Architecture Successfully Loaded!', {
  ...
  migrationSuccess:
    'From 3,031 lines to ~15 focused, testable, maintainable modules!',
})
